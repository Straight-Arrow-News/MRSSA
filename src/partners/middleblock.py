    ...
    for entry in api_response:
        ...
        content_html = (
            ...
            .replace(
                ...
                'src="https://players.brightcove.net/6279053007001/9npVofANy_default/index.html?videoId=',
            )
            .replace("\xa0", "&nbsp;")
        )
...
async def get_middleblock_feed(
    ...
    template_response = templates.get_template("middleblock.j2").render(
